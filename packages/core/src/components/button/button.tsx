...
// TODO Remove empty string defaults once Stencil supports union types.
export type ButtonFill = 'clear' | 'solid' | 'outline' | 'default';
export type ButtonSize = 'small' | 'large' | '';
export type ButtonSpan = 'block' | 'full' | '';
